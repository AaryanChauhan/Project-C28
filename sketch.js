...
function setup() {
  ...
  mangoObject1 = new Mango(1220,200,60);
  mangoObject2 = new Mango(1140,230,60);
  mangoObject3 = new Mango(1050,245,60);
  mangoObject4 = new Mango(1180,190,60);
  mangoObject5 = new Mango(1040,105,60);
  mangoObject6 = new Mango(1080,120,60);
  mangoObject7 = new Mango(1025,180,60);
  mangoObject8 = new Mango(900,240,60);
  mangoObject9 = new Mango(952,175,60);
  mangoObject10 = new Mango(865,185,60);
